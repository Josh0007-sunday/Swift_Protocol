      ...
      <section className="bg-white py-8">
        ...
        <div className="max-w-3xl mx-auto flex flex-wrap justify-center items-center gap-16">
          <div className="flex flex-col items-center">
            <img src={baseLogo} alt="Base Logo" className="h-16 w-auto object-contain mb-2" />
            <span className="text-base font-medium text-gray-800">Base</span>
          </div>
          <div className="flex flex-col items-center">
            <img src={usdcLogo} alt="USDC Logo" className="h-16 w-auto object-contain mb-2" />
            <span className="text-base font-medium text-gray-800">USDC</span>
          </div>
          <div className="flex flex-col items-center">
            <img src={morphLogo} alt="Morph Logo" className="h-16 w-auto object-contain mb-2" />
            <span className="text-base font-medium text-gray-800">Morph</span>
          </div>
        </div>
      </section>
